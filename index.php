...
<head>
    ...
    <title>Курсовой проект 2023</title>
</head>
<body class="bg-dark">
    <header class="p-3 text-bg-dark">
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" style="margin-right: 20px;" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
              <img class="" src="img/icons8W-наручники-50.png" alt="">
            </a>
    
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              <li><a href="#" class="nav-link px-2  text-secondary">Главая</a></li>
    ...
    <section class="home_section ">
        <h1 class="title container">Статистика преступности и расследования преступлений по регионам России</h1>
